...
public class CertificateCreationHelper {
     ...
     */
    public CertificateCreationHelper() throws Exception {
        // Load CA keystore.
    ...
    private KeyStore loadKeyStore() throws Exception {
		...
		try {
            ...
            // give up.
            in = CertificateCreationHelper.class.getResourceAsStream("/" + getKeyStoreName());
            if (in == null) {
                in = CertificateCreationHelper.class.getResourceAsStream("/META-INF/" + getKeyStoreName());
            }
            if (in == null) {
